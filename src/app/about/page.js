    ...
    <div className="App">
      ...
      <div className='name'>
        ...
        <div className='name-detail'>
          ...
          <p className='profile'>今大学４年でロボットに関連する研究をしています。チーム開発が大好きです。趣味はアニメとサッカー観戦などです。院進予定27卒</p>
          ...
          <Link href='/moreAbout' className="moreAboutLink">こちらにより詳しい自己紹介があります</Link>  
        </div>
      </div>
